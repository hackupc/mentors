...
config :hack_upc_mentors_api,
       HackUpcMentorsApiWeb.Endpoint,
       url: [
           host: "localhost"
       ],
       secret_key_base: System.get_env("PHOENIX_SECRET"),
       render_errors: [
           view: HackUpcMentorsApiWeb.ErrorView,
           accepts: ~w(html json)
       ],
       pubsub_server: HackUPCMentorsApi.PubSub
